	...
	echo '
					<table border="0" cellspacing="0" cellpadding="4" align="center" width="100%">
						...
						<tr class="windowbg2">
							...
							<td width="50%" align="left">
								<select name="visual_verification_type" id="visual_verification_type_select" ', (isset($context['use_graphic_library']) && $context['use_graphic_library'] == true)  ? 'onchange="refreshImages();"' : '', '>
